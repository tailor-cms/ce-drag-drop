...
End-user component for the **Drag & Drop** content element in [Tailor CMS](https://github.com/tailor-cms/author).
...
```sh
npm install @tailor-cms/ce-drag-drop-display
```
...
```ts
import { Display } from '@tailor-cms/ce-drag-drop-display';
```
